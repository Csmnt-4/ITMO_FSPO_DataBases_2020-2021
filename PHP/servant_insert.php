...
<body>
<h2>Введите данные о служащем:</h2>
<form method="POST" action="servant_insert.php">
...
if (isset($_POST['id'])) {
    ...
    $result = pg_query($db, "INSERT INTO \"hotel\".servant (id, fio) VALUES ('{$_POST['id']}', '{$_POST['fio']}')");
}
?>
</body>
</html>